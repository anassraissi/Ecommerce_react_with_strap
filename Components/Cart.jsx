...
const Cart = () => {
  ...
  const {totalPrice,totalQuantity,setshowCart,cartItems,toggleCartItemQuantity,qty,onRemove}=useStateContext();
    ...
    const response = await fetch('/api/stripe', { 
      ...
      body: JSON.stringify({cartItems}),  // sent object call cartItems
    });
    ...
    stripe.redirectToCheckout({ sessionId: data.id });  // redirect to stripe fot checkout site and managing payment
    }
  return (
